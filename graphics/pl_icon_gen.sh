...
convert "$mydir/plcomms_icon_orig.png" -resize "200x200" "$mydir/../res/themes/element/img/logos/plcomms-logo.png"
...
do
  convert "$mydir/plcomms_icon_orig.png" -resize "$wx$w" "$dest_folder/$w.png"
done
...
do
  convert "$mydir/plcomms_icon_orig.png" -resize "$wx$w" "$dest_folder/apple-touch-icon-$w.png"
done

for w in 70 150 310 
do
  convert "$mydir/plcomms_icon_orig.png" -resize "$wx$w" "$dest_folder/mstile-$w.png"
done
