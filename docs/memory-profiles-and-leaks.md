...
PL Comms usually emits slow behaviour just before it is about to crash. Getting a
...
from different points in the PL Comms session lifecycle. Most importantly, a snapshot
to establish the baseline or "normal" memory usage is useful. Taking a snapshot
roughly 30-60 minutes after starting PL Comms is a good time to establish "normal"
...
profile to us for debugging purposes, please pick the appropriate PL Comms developer and
