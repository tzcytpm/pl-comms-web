...
* Add feature flag for disabling encryption in PL Comms Call ([#11837](https://github.com/matrix-org/matrix-react-sdk/pull/11837)). Contributed by @toger5.
 ...
 * PL Comms-R:  Include crypto info in sentry ([\#11798](https://github.com/matrix-org/matrix-react-sdk/pull/11798)). Contributed by @florianduros.
 * PL Comms-R:  Include crypto info in rageshake ([\#11797](https://github.com/matrix-org/matrix-react-sdk/pull/11797)). Contributed by @florianduros.
 * PL Comms-R: Add current version of the rust-sdk and vodozemac ([\#11785](https://github.com/matrix-org/matrix-react-sdk/pull/11785)). Contributed by @florianduros.
 ...
 * Set max size for PL Comms logo in search warning ([\#11779](https://github.com/matrix-org/matrix-react-sdk/pull/11779)). Fixes #26408.
 ...
 * Add support for rendering a custom wrapper around PL Comms ([\#25537](https://github.com/vector-im/element-web/pull/25537)). Contributed by @maheichyk.
 ...
 * Support for E2EE in PL Comms Call  ([\#11492](https://github.com/matrix-org/matrix-react-sdk/pull/11492)).
 ...
 * Lock out the first tab if PL Comms is opened in a second tab. ([\#11425](https://github.com/matrix-org/matrix-react-sdk/pull/11425)). Fixes #25157.
 ...
 * Fix incompatibility of Soft Logout with PL Comms-R ([\#11468](https://github.com/matrix-org/matrix-react-sdk/pull/11468)).
 ...
 * Autoapprove PL Comms Call oidc requests ([\#11209](https://github.com/matrix-org/matrix-react-sdk/pull/11209)). Contributed by @toger5.
 ...
 * PL Comms-R: Populate device list for right-panel ([\#10671](https://github.com/matrix-org/matrix-react-sdk/pull/10671)). Contributed by @florianduros.
 ...
 * PL Comms-R: Starting a DMs with a user ([\#10673](https://github.com/matrix-org/matrix-react-sdk/pull/10673)). Contributed by @florianduros.
 ...
 * Fix soft crash with PL Comms call widgets ([\#10684](https://github.com/matrix-org/matrix-react-sdk/pull/10684)).
 ...
 * Fix block/inline PL Comms descendants error noise in `NewRoomIntro.tsx` ([\#10412](https://github.com/matrix-org/matrix-react-sdk/pull/10412)). Contributed by @MadLittleMods.
 ...
 * PL Comms-R: fix rageshages ([\#10081](https://github.com/matrix-org/matrix-react-sdk/pull/10081)). Fixes #24430.
 ...
 * Honor font settings in PL Comms Call ([\#9751](https://github.com/matrix-org/matrix-react-sdk/pull/9751)). Fixes #23661.
