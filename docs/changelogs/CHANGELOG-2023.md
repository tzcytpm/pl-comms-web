...
* Add feature flag for disabling encryption in privateLINE Comms Call ([#11837](https://github.com/matrix-org/matrix-react-sdk/pull/11837)). Contributed by @toger5.
 ...
 * privateLINE Comms-R:  Include crypto info in sentry ([\#11798](https://github.com/matrix-org/matrix-react-sdk/pull/11798)). Contributed by @florianduros.
 * privateLINE Comms-R:  Include crypto info in rageshake ([\#11797](https://github.com/matrix-org/matrix-react-sdk/pull/11797)). Contributed by @florianduros.
 * privateLINE Comms-R: Add current version of the rust-sdk and vodozemac ([\#11785](https://github.com/matrix-org/matrix-react-sdk/pull/11785)). Contributed by @florianduros.
 ...
 * Set max size for privateLINE Comms logo in search warning ([\#11779](https://github.com/matrix-org/matrix-react-sdk/pull/11779)). Fixes #26408.
 ...
 * Add support for rendering a custom wrapper around privateLINE Comms ([\#25537](https://github.com/vector-im/element-web/pull/25537)). Contributed by @maheichyk.
 ...
 * Support for E2EE in privateLINE Comms Call  ([\#11492](https://github.com/matrix-org/matrix-react-sdk/pull/11492)).
 ...
 * Lock out the first tab if privateLINE Comms is opened in a second tab. ([\#11425](https://github.com/matrix-org/matrix-react-sdk/pull/11425)). Fixes #25157.
 ...
 * Fix incompatibility of Soft Logout with privateLINE Comms-R ([\#11468](https://github.com/matrix-org/matrix-react-sdk/pull/11468)).
 ...
 * Autoapprove privateLINE Comms Call oidc requests ([\#11209](https://github.com/matrix-org/matrix-react-sdk/pull/11209)). Contributed by @toger5.
 ...
 * privateLINE Comms-R: Populate device list for right-panel ([\#10671](https://github.com/matrix-org/matrix-react-sdk/pull/10671)). Contributed by @florianduros.
 ...
 * privateLINE Comms-R: Starting a DMs with a user ([\#10673](https://github.com/matrix-org/matrix-react-sdk/pull/10673)). Contributed by @florianduros.
 ...
 * Fix soft crash with privateLINE Comms call widgets ([\#10684](https://github.com/matrix-org/matrix-react-sdk/pull/10684)).
 ...
 * Fix block/inline privateLINE Comms descendants error noise in `NewRoomIntro.tsx` ([\#10412](https://github.com/matrix-org/matrix-react-sdk/pull/10412)). Contributed by @MadLittleMods.
 ...
 * privateLINE Comms-R: fix rageshages ([\#10081](https://github.com/matrix-org/matrix-react-sdk/pull/10081)). Fixes #24430.
 ...
 * Honor font settings in privateLINE Comms Call ([\#9751](https://github.com/matrix-org/matrix-react-sdk/pull/9751)). Fixes #23661.
