 ...
 * Update copy of 'Change layout' button to match privateLINE Comms Dev Call ([\#9703](https://github.com/matrix-org/matrix-react-sdk/pull/9703)).
 ...
 * Fix embedded privateLINE Comms Dev Call screen sharing ([\#9485](https://github.com/matrix-org/matrix-react-sdk/pull/9485)). Fixes #23571.
 ...
 * Add privateLINE Comms Dev Call participant limit ([\#23431](https://github.com/vector-im/element-web/pull/23431)).
 * Add privateLINE Comms Dev Call `brand` ([\#23443](https://github.com/vector-im/element-web/pull/23443)).
 ...
 * Pass the current language to privateLINE Comms Dev Call ([\#9427](https://github.com/matrix-org/matrix-react-sdk/pull/9427)).
 * Hide screen-sharing button in privateLINE Comms Dev Call on desktop ([\#9423](https://github.com/matrix-org/matrix-react-sdk/pull/9423)).
 ...
 * Disconnect other connected devices (of the same user) when joining an privateLINE Comms Dev call ([\#9379](https://github.com/matrix-org/matrix-react-sdk/pull/9379)).
 ...
 * Add privateLINE Comms Dev Call participant limit ([\#9358](https://github.com/matrix-org/matrix-react-sdk/pull/9358)).
 * Add privateLINE Comms Dev Call room settings ([\#9347](https://github.com/matrix-org/matrix-react-sdk/pull/9347)).
 ...
 * Add notifications and toasts for privateLINE Comms Dev Call calls ([\#9337](https://github.com/matrix-org/matrix-react-sdk/pull/9337)).
 ...
 * Pass the homeserver's base URL to privateLINE Comms Dev Call ([\#9429](https://github.com/matrix-org/matrix-react-sdk/pull/9429)). Fixes #23301.
 ...
 * Close incoming privateLINE Comms Dev call toast when viewing the call lobby ([\#9375](https://github.com/matrix-org/matrix-react-sdk/pull/9375)).
 ...
 * Fix device selection in pre-join screen for privateLINE Comms Dev Call video rooms ([\#9321](https://github.com/matrix-org/matrix-react-sdk/pull/9321)). Fixes #23331.
...
## ✨ Features
 * privateLINE Comms Dev Call video rooms ([\#9267](https://github.com/matrix-org/matrix-react-sdk/pull/9267)).
...
## ✨ Features
 * Enable URL tooltips on hover for privateLINE Comms Dev Desktop ([\#22286](https://github.com/vector-im/element-web/pull/22286)). Fixes undefined/element-web#6532.
 ...
 * Option to disable hardware acceleration on privateLINE Comms Dev Desktop ([\#22295](https://github.com/vector-im/element-web/pull/22295)). Contributed by @novocaine.
 ...
 * Show notifications even when privateLINE Comms Dev is focused ([\#8590](https://github.com/matrix-org/matrix-react-sdk/pull/8590)). Contributed by @sumnerevans.
 ...
 * Fix relative link handling in privateLINE Comms Dev Desktop ([\#7708](https://github.com/matrix-org/matrix-react-sdk/pull/7708)). Fixes #20783.
