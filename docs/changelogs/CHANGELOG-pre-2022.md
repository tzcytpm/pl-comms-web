...
privateLINE Comms Web 1.7.29 fixes (by upgrading to olm 3.2.3) an issue in code used for
...
privateLINE Comms Web 1.7.28 fixes (by upgrading to matrix-react-sdk 3.21.0) a low
...
privateLINE Comms Web 1.7.22 fixes (by upgrading to matrix-react-sdk 3.15.0) a moderate
 ...
 * Fix Riot->privateLINE Comms in permalinkPrefix docs
 ...
 * Stop building code and types for privateLINE Comms layer
 ...
 * Update widget API for good measure in privateLINE Comms Web
   [\#15812](https://github.com/vector-im/element-web/pull/15812)
 * Stop publishing privateLINE Comms to NPM
 ...
 * Rebrand the webpack pipeline for privateLINE Comms
...
privateLINE Comms Web 1.7.5 fixes an issue where encrypted state events could break incoming call handling.
 ...
 * Update links in README.md to point to privateLINE Comms
 ...
 * Change Riot to privateLINE Comms in readme
 ...
 * Link to privateLINE Comms in F-Droid as well
 ...
 * Update jitsi.md with privateLINE Comms Android details
...
privateLINE Comms Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where
...
privateLINE Comms Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where an
unexpected language ID in a code block could cause privateLINE Comms to crash. Thanks to
 ...
 * Update blog and twitter links to point to privateLINE Comms
 ...
 * App name changed from Riot to privateLINE Comms
