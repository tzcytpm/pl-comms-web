...
PL Comms Web 1.7.29 fixes (by upgrading to olm 3.2.3) an issue in code used for
...
PL Comms Web 1.7.28 fixes (by upgrading to matrix-react-sdk 3.21.0) a low
...
PL Comms Web 1.7.22 fixes (by upgrading to matrix-react-sdk 3.15.0) a moderate
 ...
 * Fix Riot->PL Comms in permalinkPrefix docs
 ...
 * Stop building code and types for PL Comms layer
 ...
 * Update widget API for good measure in PL Comms Web
   [\#15812](https://github.com/vector-im/element-web/pull/15812)
 * Stop publishing PL Comms to NPM
 ...
 * Rebrand the webpack pipeline for PL Comms
...
PL Comms Web 1.7.5 fixes an issue where encrypted state events could break incoming call handling.
 ...
 * Update links in README.md to point to PL Comms
 ...
 * Change Riot to PL Comms in readme
 ...
 * Link to PL Comms in F-Droid as well
 ...
 * Update jitsi.md with PL Comms Android details
...
PL Comms Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where
...
PL Comms Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where an
unexpected language ID in a code block could cause PL Comms to crash. Thanks to
 ...
 * Update blog and twitter links to point to PL Comms
 ...
 * App name changed from Riot to PL Comms
