# How to translate privateLINE Comms

## Requirements

-   Web Browser
-   Be able to understand English
-   Be able to understand the language you want to translate privateLINE Comms into
...
These things are placeholders that are expanded when displayed by privateLINE Comms. They can be room names, usernames or similar.
